  ...
  function checkValidation(event) {
    console.log("XXXXXXXXX", "CHECK VALIATION")
    ...
    console.log("checkvalidation", isCheckFirstName,
  iscCheckLastName,
  isCheckEmail,
  ischeckMessage)
    if (
      ...
      // We display the modal of the successful message.
   {
    confirmation.style.display="block";
     console.log("Prenom : " + identityName.value + ", Nom : " + identityName.value + ", Email : " + email.value + ", Message : " + message.value);
    }
    return false
